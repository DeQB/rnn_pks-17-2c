...
def test_model(model, X_test, Y_test, unnormalized_bases):
    ...
    for i in range(Y_test.shape[0]):
        ...
        # print(real_y_predict[i])
    # real_y_predict=np.reshape(real_y_predict,(-1,))
    # print(real_y_predict.shape)
    # print(real_y_predict)
    # print(Y_test.shape)
...
X_train, Y_train, X_test, Y_test, Y_daybefore, unnormalized_bases, window_size = load_data("btc_data.csv", 50)
# print (X_train.shape)
# print (Y_train.shape)
# print (X_test.shape)
# print (Y_test.shape)
...
model, training_time = fit_model(model, X_train, Y_train, 1024, 1, .05)
